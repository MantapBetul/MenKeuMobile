...
public class mainKeuangan extends AppCompatActivity {
    ...
    public static String id, status, jumlah, keterangan, tanggal, tanggal2, tgl_dari, tgl_ke,link,username,username1;
    ...
    private void onloadingRefreshing() {
    ...
    private void readData(){
        ...
        AndroidNetworking.post(link)
                .addBodyParameter("username", user.getName())
    ...
    private void adapterRead(){
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, arusuang, R.layout.listkeuangan,
                new String[]{"id", "status", "jumlah","keterangan", "username", "tanggal","tanggal2"},
                new int[]{R.id.text_transaksi_id, R.id.text_status, R.id.text_jumlah, R.id.text_keterangan, R.id.text_transaksiUsername, R.id.text_tanggal,R.id.text_tanggal2}
        );
        ...
        list_keuangan.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long iD) {
                ...
                username = ((TextView)view.findViewById(R.id.text_transaksiUsername)).getText().toString();
        ...
        SmoothDateRangePickerFragment smoothDateRangePickerFragment = SmoothDateRangePickerFragment.newInstance(
                new SmoothDateRangePickerFragment.OnDateRangeSetListener() {
                    ...
                    public void onDateRangeSet(SmoothDateRangePickerFragment view,
                        ...
                        link=Config.Host+"filter2.php?dari="+tgl_dari+"&ke="+tgl_ke+"&username="+username1;
                        readData();
                    }
                });
